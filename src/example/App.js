...
class Dropdown extends Component {
    ...
    render() {
        return <div className="Dropdown">
            <button type="button" className="Dropdown__Button" ref={(node) => this.dropdown.listenDropdownOpener(node)}>
                {this.props.title}
            </button>
...
class Menu extends Component {
    ...
    render() {
        return <div className="Menu__Wrapper">
            <button className="Menu__Hamburger" ref={(node) => this.dropdown.listenDropdownOpener(node)}></button>
            <div
                className={`Menu ${this.state.isOpened ? 'Menu_opened' : ''}`}
                ref={(node) => {
                    this.dropdown.listenDropdownContainer(node);
                    this.container = node;
                }}
